...
- **Contatto consigliato (★)**: marca la persona da cui partire per il primo approccio. Di norma è chi è già nei lead Drive o il decisore raggiungibile.
- **Nodi fantasma (tratteggiati)**: chi è rilevante ma ignoto o non raggiungibile (es. decisore di budget da identificare, CTO non presente nei lead Drive). Vanno mostrati come obiettivo, non nascosti. In Deep, ogni nodo fantasma ereditato da una run di tier inferiore va ri-tentato alla fonte: se il ruolo si conferma, promuovilo a nodo pieno nella fascia corretta; il fantasma resta solo per chi è ancora ignoto o non raggiungibile dopo i round Deep.
...
Questa mappa si costruisce intrecciando i contatti dai lead Drive (Fase 1) con l'organigramma dal web: un contatto caldo nelle liste lead diventa quasi sempre il nodo ★.

## Dati di contatto su ogni persona

- **Contatti presenti nei fogli lead**: riporta sempre email e, se presente, telefono accanto alla persona (nel nodo dell'organigramma e nella scheda). Telefono assente nel foglio si segnala "n.d.", mai inventato.

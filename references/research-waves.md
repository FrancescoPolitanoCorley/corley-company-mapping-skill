...
"Sei un ricercatore. Azienda: {nome}. Angolo: {angolo}. Esegui {Wave X} secondo `references/research-principles.md` e `references/honesty-protocol.md`. Scrivi i risultati grezzi in `raw/{azienda}/wave-X.md` con label `[Dato]`/`[Stima]`/`[Ipotesi]`, date e fonti. Dichiara i gap."
